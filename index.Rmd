...
In the Caucasus this category is commonly expressed with a perfect form of the verb, indicating that the speaker did not witness the event. Other means to express evidentiality include particles and specialized auxiliaries (see an overview in Forker [-@forker2018evid]).
...
* Chechen and Tsakhur instead employ a specialized auxiliary to express evidentiality[^2]
